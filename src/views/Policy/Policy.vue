    ...
    <div class="policy">
      <div class="policy__item">
        <p class="policy__text">
          ...
          onemorelottery..tw/；以下稱｢本網站｣）是由再來一抽娛樂有限公司（以下稱本公司）所經營之電子商務網站，並依據本網站使用條款及其他相關規範或公告提供您相關服務。您第一次消費前，請詳細閱讀並同意本網站使用條款後，再填寫基本資料加入會員。當您完成前述流程，即表示您已經閱讀、瞭解且同意本網站使用條款之全部內容與約定，如不同意本網站使用條款之全部或部分者，請勿填寫基本資料註冊本網站會員。
        </p>
      </div>
      <div class="policy__item">
        <p class="policy__text">
      ...
      <div class="policy__item">
        ...
        <div class="policy__item-main">
          ...
          <p class="policy__text">其他本公司認為有需要暫停或終止服務之情形。</p>
          <p class="policy__text">
      ...
      <div class="policy__item">
        ...
        <div class="policy__item-main">
          ...
          <p class="policy__text">本契約條款如有疑義，將為有利於客戶之解釋。</p>
          <p class="policy__text">
