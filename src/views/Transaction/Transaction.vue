<template>
  <SectionHeader title="交易說明" />
  <Card custom-class="m-t-24">
    <div class="transaction">
      <div class="transaction__item">
        <div class="transaction__item-title">
          <p class="transaction__text">代幣購入須知</p>
        </div>
        <div class="transaction__item-main">
          <p class="transaction__text">
            1.購買前請三思，再來一抽(以下簡稱本網站)所販售之遊戲代幣，訂單成立後，將無法轉讓給第三者。
          </p>
          <p class="transaction__text">
            2.再來一抽會員所儲值的代幣等同於「現金禮券」，以下簡稱「代幣」。會員可以在再來一抽平台上消費任何商品。
          </p>
          <p class="transaction__text">
      ...
      <div class="transaction__item">
        <div class="transaction__item-title">
          <p class="transaction__text">什麼狀況下需要開立發票？</p>
        </div>
        <div class="transaction__item-main">
          <p class="transaction__text">
          ...
          <p class="transaction__text">
            1.再來一抽將於儲值完後，由系統自動開立電子發票到會員註冊的Email。
          </p>
        </div>
      </div>
      ...
      <div class="transaction__item">
        <div class="transaction__item-title">
          <p class="transaction__text">退費相關</p>
        </div>
        <div class="transaction__item-main">
          <p class="transaction__text">
            1.若欲取消已付款購買的代幣，需確保沒有使用代幣的情況下，請於購買流程完成七日內提出申請。
          </p>
          <p class="transaction__text">
      ...
      <div class="transaction__item">
        <div class="transaction__item-title">
          <p class="transaction__text">儲值流程教學</p>
        </div>
        <div class="transaction__item-main">
          <p class="transaction__text">
      ...
      <div class="transaction__item">
        <div class="transaction__item-title">
          <p class="transaction__text">遊戲獎品</p>
        </div>
        <div class="transaction__item-main">
          <p class="transaction__text">
      ...
      <div class="transaction__item">
        <div class="transaction__item-title">
          <p class="transaction__text">寄送說明</p>
        </div>
        <div class="transaction__item-main">
          <p class="transaction__text">
          ...
          <p class="transaction__text">
            3.獎品皆以紙箱包裝避免運輸碰撞造成嚴重損壞，但運送途中內外盒都可能受到撞擊/擠壓，無法保證盒況，若十分在意盒況者請三思後再遊玩。
          </p>
      ...
      <div class="transaction__item">
        <div class="transaction__item-title">
          <p class="transaction__text">系統安全</p>
        </div>
        <div class="transaction__item-main">
          <p class="transaction__text">
          ...
          <div class="m-l-40">
            ...
            <p class="transaction__text">3.2發生突發性之電子通信設備故障時；</p>
            <p class="transaction__text">
      ...
      <div class="transaction__item">
        <div class="transaction__item-title">
          <p class="transaction__text">相關法律權益</p>
        </div>
        <div class="transaction__item-main">
          <p class="transaction__text">
      ...
      <div class="transaction__item">
        <div class="transaction__item-title">
          <p class="transaction__text">權利保留</p>
        </div>
        <div class="transaction__item-main">
          <p class="transaction__text">
